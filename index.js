...
function saveData(event) {
	...
	axios.post('https://crudcrud.com/api/6ed4f7723cc3477fbf0a1bd7ae999036/listProduct', productStore)
...
function displayOnScreen(productStore) {
	if (productStore.name === '' || productStore.price === '') {
		...
		deleteButton.onclick = () => {
			axios.delete('https://crudcrud.com/api/6ed4f7723cc3477fbf0a1bd7ae999036/listProduct/' + id)
				.then(() => {
					console.log(res);
				})
...
window.addEventListener('DOMContentLoaded', () => {
	axios.get('https://crudcrud.com/api/6ed4f7723cc3477fbf0a1bd7ae999036/listProduct')
		.then((res) => {
